...
let isAndroid = navigator.userAgent.toLowerCase().match('android')
...
AudioFormatReader_MPEG.prototype._WindowSize = isAndroid ? 30 : 25
...
AudioFormatReader_MPEG.prototype._UseFrames = isAndroid ? 5 : 2
